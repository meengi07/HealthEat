...
public class SearchTable2 extends JFrame {
	...
	public SearchTable2() {
		...
		Object[][] data = new Object[][] {
			{"비타민D3", "Now Foods", "120정", "6,500", "", "튼튼한 뼈 유지, 면역계 강화", 0},
			{"마그네슘", "Doctor's Best", "120정", "10,700", "", "뼈, 심장, 신경 및 근육 건강 지원", 0},
			{"CoQ10", "California Gold Nutrition", "150정", "20,000", "", "심혈관계 건강 지원", 0},
			{"LactoBif 프로바이오틱", "California Gold Nutrition", "60정", "22,000", "", "소화기관 건강 지원", 0},
			{"프로폴리스", "Y.S. Eco Bee Farms", "90정", "12,800", "", "호흡기 건강 지원", 0},
			{"분리유청단백질", "EVLution Nutrition", "1.6파운드", "31,000", "", "근육 생성, 근육 회복, 단백질 합성, 근육 강화", 0}
		};
